<template>
    <div>
        ...
        <v-container fluid>
            ...
            <v-container
                v-for="(x, projecttype) in Projectlinks"
                :key="projecttype"
                fluid
            >
                <v-row>
            ...
            meta: [
                {
                    ...
                    name: 'Portfolio',
                    content:
                        "Portfolio of the full stack developer & Data scientist Dimitri Lesas', who is avaliable for employment / Contract Work / freelance work. Here you can filter my various projects by skill.",
                },
            ],
        }
    },
    computed: {
        Projectlinks() {
            ...
            for (const project in Portfolio) {
                if (
                    Portfolio[project].SkillsUsed.some((r) =>
                        this.filteredforskills.includes(r)
                    )
                ) {
                    if (!(Portfolio[project].Category in Projectlinks)) {
                        Projectlinks[Portfolio[project].Category] = {}
                    }
                    Projectlinks[Portfolio[project].Category][project] =
                        Portfolio[project]
                }
            }
            return Projectlinks
