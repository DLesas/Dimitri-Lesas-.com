                ...
                <v-row align="center" justify="center" no-gutters>
                    <v-col cols="12">
                        ...
                        <v-switch
                            ...
                            :label="
                                skillsprim
                                    ? 'Use Skills as Primary Category'
                                    : 'Use Languages as Primary Category'
                            "
                        >
                        </v-switch>
                        <v-spacer />
            ...
            <v-row v-if="['xs', 'sm'].includes(view)">
                <v-col cols="4">
                    <v-img
                        ...
                        contain
                        :src="selectedicon"
                        :height="heightofimg + 30"
                        :max-width="heightofimg"
                        :alt="'Image portraying ' + selectedicon.split('/')[1]"
                    >
            ...
            <v-row no-gutters class="">
                <v-col cols="12">
                    <network-tree
                        ref="skilltree"
                        :networkdata="
                            skillsprim ? NetworkdataLanguage : NetworkdataSkills
                        "
                        :color="color"
                        @HoverOnNode="ChangeSelected"
                    />
                </v-col>
            </v-row>
        </v-container>
...
export default {
    ...
    data() {
        return {
            ...
            mounted: false,
            heightofimg: 100,
            selectedskill: ['xs', 'sm', 'md'].includes(
                this.$vuetify.breakpoint.name
            )
                ? 'Drag a node'
                : 'Hover over a Node',
            selectedskilltext: ['xs', 'sm', 'md'].includes(
                this.$vuetify.breakpoint.name
            )
            ...
            meta: [
                {
                    ...
                    name: 'Skills',
                    content:
                        "Skills page of the full stack developer & Data scientist Dimitri Lesas', who is avaliable for employment / Contract Work / freelance work. Here you can find a Full overview of my tech stack with skills including AWS, Python, Numpy, Pandas, Microsoft Power-BI, Tensorflow, PyTorch, Scikit-Learn and Javascript.",
                },
            ],
        }
    },
    ...
    watch: {
        ...
        dark(newValue) {
            if (
                this.selectedskill === 'Drag a node' ||
                this.selectedskill === 'Hover over a Node'
            ) {
    ...
    methods: {
        ...
        ChangeSelected(name, color) {
            ...
            if (['xs', 'sm'].includes(this.view)) {
                ...
                setTimeout(() => {
                    this.heightofimg =
                        this.$refs.textcontent.getBoundingClientRect().bottom -
                        this.$refs.textcontainer.getBoundingClientRect().top
                }, 20)
            }
        },
            ...
            if (this.packages[Skill]) {
                ...
                this.selectedicon =
                    ...
                    Object.prototype.hasOwnProperty.call(
                        ...
                        ? this.packages[Skill].dark
                        : this.packages[Skill].icon
                ...
                this.selectedicon =
                    ...
                    Object.prototype.hasOwnProperty.call(
                        ...
                        ? this.skils[Skill].dark
                        : this.skils[Skill].icon
